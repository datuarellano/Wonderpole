...
AudioInputI2S                   i2s; //xy=1865,1420
...
AudioConnection        patchCord68(i2s, 0, mixer2, 2);
AudioConnection        patchCord69(i2s, 1, mixer2, 3);
